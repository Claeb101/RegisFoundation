...
export class AboutComponent implements OnInit {
  ...
  constructor() {
    ...
    this.regisTimeline = [
      {date: "March 12, 1961", description: "Dr. A.N.S. Regis was born in Thuvarlankanmoi, a village in the Sivagangai-district of Tamil Nadu. He is the fourth son of Mr. VS. Amalorpavam, school teacher, and Mrs. A. Sebastiammal, farmer and home maker."},
      ...
      {date: "December 18, 1992", description: "At just 31 years of age, Dr. A.N.S. Regis breathed his last at KMC Hospital, Chennai after a road accident."},
    ]
