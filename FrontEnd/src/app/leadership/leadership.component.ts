...
export class LeadershipComponent implements OnInit {
  ...
  constructor() {
    ...
    this.members = [
      ...
      {isRevealed: false, image_path: pics_dir + "Alex.jpg", description: `Alex Amalorpavam is a web designer, and front-end software developer who takes a wide view of the whole system. Alex inherently understands that the customer is the single most valuable asset an organization can have, and is driven by the unrelenting pursuit of customer-driven, customer-service focus, ideals and user experience. Alex earned an MBA, and a Bachelor of Science degree in Computer Engineering from Madurai University. Alex enjoys playing football (soccer) and travelling with his wife Steffi when they can find time. Alex is honored and excited to uphold Regi's legacy by the creation of this foundation.`, name: "A. Nathan Alexander", role: "Mentor"},

      {isRevealed: false, image_path: pics_dir + "John.jpeg", description: "A post graduate in sociology. He has more than 30 years of experience in imparting social analysis and leadership training for university students and rural youth. He motivates and involves students in the tree growing mission, and he is responsible to lead the foundation as its honorary managing trustee.", name: "John Peter.A", role: "Trustee"},
