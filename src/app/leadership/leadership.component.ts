...
export class LeadershipComponent implements OnInit {
  ...
  constructor() {
    ...
    this.members = [
      ...
      {image_path: img, description: des, name: "A. Nathan Alexander", role: "Mentor"},
      ...
      {image_path: img, description: "BDS", name: "Dr. J. Sebasti Jeya Premi", role: "Ambassador"},
      {image_path: img, description: "MBBS", name: "Dr. J. Jane Priya", role: "Ambassador"},
      {image_path: img, description: "MBBS", name: "Dr. S. Sam Stanley", role: "Ambassador"},
      {image_path: img, description: "MBBS", name: "Dr. R. Aaron Aravindh Regis", role: "Ambassador"},
      {image_path: img, description: "MBBS", name: "Dr. S. Edberg Robin", role: "Ambassador"},
      {image_path: img, description: "BDS", name: "Dr. S. Rowina Suzanne", role: "Ambassador"},
      {image_path: img, description: "MA BEd", name: "S. Lotus Nirmala", role: "Ambassador"},
      {image_path: img, description: "MSc MPhil MEd", name: "J. Angel Manju", role: "Ambassador"},
      {image_path: img, description: "MA BEd", name: "S. Violet Adaikala Gracy", role: "Ambassador"},
      {image_path: img, description: "MSc MBA", name: "A. JoanOfArc", role: "Ambassador"},
      {image_path: img, description: "MA BSc", name: "A. James Paari Mannan", role: "Ambassador"},
