...
export class LeadershipComponent implements OnInit {
  ...
  constructor() {
    ...
    this.members = [
      ...
      {image_path: pics_dir + "Alex.jpg", description: des, name: "A. Nathan Alexander", role: "Mentor"},
      ...
      {image_path: pics_dir + "Manju2.jpg", description: "The second younger sister of Dr. Regis, presently working as a chemistry teacher in Trichy.", name: "J. Angel Manju, MSc; MPhil; MEd", role: "Ambassador"},
      {image_path: pics_dir + "Gracy.jpg", description: "Mrs. Violet Adaikala Gracy was the first social worker in the family. She is a determined, honest, and sincere person who has always wanted to help people. Dr. Regis has never failed to inspire and influence a numerous amount of lives including Gracy's. She is currently working at Trends Tower a garment production unit in Coimbatore.", name: "S. Violet Adaikala Gracy, MA; BEd", role: "Ambassador"},
      {image_path: pics_dir + "Joan.png", description: "Joanofarc Amalorpavam, sister of Dr. Regis, is an IT software professional. She has a strong passion for helping others and believes that IT can have a powerful impact in modern society. Because of Dr. Regis’ dedication, hardworking nature, service, and humility, she strives to make the most out of every single opportunity thrown her way. She is currently working in Virginia, U.S.A.", name: "A. JoanOfArc, MSc; MBA", role: "Ambassador"},
